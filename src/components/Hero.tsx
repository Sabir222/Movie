        ...
        <Link to={`/movie/${movie.id}`} key={key}>
          <div className="flex-col items-center justify-center">
            <div className="h-[260px] w-[220px] ring-4 ring-gray-950 relative overflow-hidden group cursor-pointer ">
              ...
              <div className="absolute inset-0 flex-col items-center justify-center px-4 text-center translate-y-[100%] group-hover:translate-y-[110px] transition-all duration-700">
